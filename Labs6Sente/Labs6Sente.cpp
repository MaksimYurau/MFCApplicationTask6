...
// Labs6Sente.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLabs6SenteApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLabs6SenteApp

CLabs6SenteApp::CLabs6SenteApp()
{
...
// Единственный объект CLabs6SenteApp

CLabs6SenteApp theApp;


// Инициализация CLabs6SenteApp

BOOL CLabs6SenteApp::InitInstance()
{
